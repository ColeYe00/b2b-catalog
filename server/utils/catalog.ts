...
export interface ProductDbRow extends RowDataPacket {
  id: string | number
  sku: string
  name_en: string
  name_cn: string | null
...
export function toCatalogProduct(row: ProductDbRow): CatalogProduct {
  return {
    id: String(row.id),
    sku: row.sku,
    name_en: row.name_en,
...
export const PRODUCT_COLUMNS = `
  id, sku, name_en, name_cn, specs, price, currency, moq,
